...
alias b='cd ~/voltageos && source build/envsetup.sh && breakfast Spacewar lunch voltage_Spacewar-trunk_staging-user && mka baconlunch voltage_Spacewar-trunk_staging-user && mka bacon brunch Spacewar'
alias sb='s && b'
alias c='clear'
alias cb='c && b'
```
